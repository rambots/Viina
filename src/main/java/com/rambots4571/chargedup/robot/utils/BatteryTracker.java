...
import com.rambots4571.chargedup.robot.Constants.Settings.Mode;
import com.rambots4571.chargedup.robot.Constants.Settings.RobotType;
...
public class BatteryTracker {
  ...
  public static String scanBattery(double timeout) {
    if (Settings.getMode() == Mode.REAL) {
      if (supportedRobots.contains(Settings.getRobot())) {
